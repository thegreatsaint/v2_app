					...
					success: function(data)
					{
						try
						{
							...
							if($arr.msg_type == 'success')
							{
								...
								window.location.replace($("#hid_base_url").val()+"index.php/dashboard/");
							}
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-white" style="box-shadow:0px 1px 1px rgba(204,204,204,0.2); background:url(<?php echo $this->config->item("rest_server_url")?>assets/images/site_images/small_blue_tile.jpg)">
                          ...
                          <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                            ...
                            <form class="form-inline my-3 my-lg-0">
                                 <div class="dropdown" style="min-width:200px" title="Login to form">
                                      <div style="" onclick=$("#staff_login_modal").modal("show") class="text-white need_hover btn gst_round dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<div class="container">
	<div class="row">
        ...
        <div class="col-lg-6">
        	<section class="wow animated fadeIn" data-wow-duration="1s" data-wow-delay="2s">
                <h1>&nbsp;</h1>
                <div class="font-weight-light display-4 text-white">
