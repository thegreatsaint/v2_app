...
ob_start();
class Referral_source extends CI_Controller {
	...
	public function get_referral_source()
	{
		...
		$request .= "index.php/api/configurations/referral_source/get_referral_source";
		$request .= "?";
	...
	public function get_referral_person()
	{
		extract($_POST);
		
		$request =  $this->config->item("rest_server_url");
		$request .= "index.php/api/configurations/referral_source/get_referral_person";
		$request .= "?";
	...
	public function add_new()
	{
		...
		$request =  $this->config->item("rest_server_url");
		$request .= "index.php/api/configurations/referral_source/add_new";
		$request .= "?";
		...
		$request .= "req_ref_source_name=".urlencode($req_ref_source_name);	
		$request .= "&";
		
		$request .= "req_ref_source_desc=".urlencode($req_ref_source_desc);	
	...
	public function delete()
	{
		...
		$request =  $this->config->item("rest_server_url");
		$request .= "index.php/api/configurations/referral_source/delete";
		$request .= "?";
	...
	public function view()
	{
		...
		$request =  $this->config->item("rest_server_url");
		$request .= "index.php/api/configurations/referral_source/view";
		$request .= "?";
