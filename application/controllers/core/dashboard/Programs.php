...
class Programs extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('dashboard/programs/programs');
	...
	public function view()
	{
		...
		$request =  $this->config->item("rest_server_url");
		$request .= "index.php/api/programs/programs/view";
		$request .= "?";
		...
		$request .="search_key_word=".urlencode($search_key_word);	
	...
	public function get_program_members()
	{
		...
		$request =  $this->config->item("rest_server_url");
		$request .= "index.php/api/programs/programs/get_program_members";
		$request .= "?";
	...
	public function add_new()
	{
		...
		$request =  $this->config->item("rest_server_url");
		$request .= "index.php/api/programs/programs/add_new";
		$request .= "?";
		...
		$request .= "req_program_patient=".$req_program_patient;
		$request .= "&";
