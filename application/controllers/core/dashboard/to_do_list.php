...
class To_do_list extends CI_Controller {
	...
	function __construct()
    {
		...
		$this->Functions->check_basic_authentication($_SESSION[$this->config->item("sess_cookie_name")]["staff_username"],"to_do_list","");		
    }
	 	
	public function index()
	{
		$data['page_title'] = 'To Do List';
		$data['rights'] = $this->Functions->get_staff_task_permission($_SESSION[$this->config->item("sess_cookie_name")]["staff_username"],"patients");
		$this->load->view('common/header',$data);
		$this->load->view('common/common_script',$data);
		$this->load->view('common/top_bar',$data);
		$this->load->view('dashboard/to_do_list/to_do_list');
		if($this->Functions->get_staff_task_permission($_SESSION[$this->config->item("sess_cookie_name")]["staff_username"],"to_do_list") == 'full')
		{
	...
	public function delete()
	{
		...
		$request =  $this->config->item("rest_server_url");
		$request .= "index.php/api/patients/patients/delete";
		$request .= "?";
	...
	public function view()
	{
		...
		$request =  $this->config->item("rest_server_url");
		$request .= "index.php/api/patients/patients/view";
		$request .= "?";
